defmodule TerrManWeb.CMS.PageControllerTest do
  use TerrManWeb.ConnCase

  alias TerrMan.CMS

  @create_attrs %{body: "some body", integer: "some integer", title: "some title", views: "some views"}
